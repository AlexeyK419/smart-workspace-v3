      ...
      <div class="hero-points">
        <div class="point-card">
          ...
          <div>
            ...
            <p>Возможность управления своими курсами, проектами и задачами</p>
          </div>
        </div>
        <div class="point-card">
          <span>🗓️</span>
          <div>
            ...
            <p>Составляйте расписание и повышайте личную продуктивность</p>
          </div>
        </div>
        <div class="point-card">
          <span>✨</span>
          <div>
            ...
            <p>Помогает разбираться в темах и планировать подготовку</p>
          </div>
        </div>
      </div>
    </div>
