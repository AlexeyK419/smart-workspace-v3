    ...
    <div v-if="isOpen" class="chat-panel">
      <div class="chat-panel-header">
        ...
        <div class="chat-ai-info">
          <div class="chat-ai-name">Ассистент учебного пространства</div>
...
const messages = ref([
  {
    ...
    role: 'assistant',
    time: now(),
    content: 'Привет! Я **ассистент учебного пространства**. Помогу разобрать тему, составить план подготовки и подсказать следующий шаг по заданию. Готовые решения не даю, но могу помочь дойти до них самому.',
  },
])
